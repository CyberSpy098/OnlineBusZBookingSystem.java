...
public class HelpingCancelTicket
{
    ...
    //-----------------------------------------------------------------------------------------------------------------//
    public static void DeleteBooking(int T)
    {
        Book[T].setName("");
        ...
        {
            Book[T].setName(getName(i+1));
            Book[T].setFatherName(getFatherName(i+1));
            Book[T].setCNIC(getCNIC(i+1));
            Book[T].setPhone_Number(getPhone_Number(i+1));
            Book[T].setTo(getTo(i+1));
            Book[T].setFrom(getFrom(i+1));
        }
        DeleteTicket();
